        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-6 col-md-offset-3">
                <div class="btn-group  pull-right">
                    ...
                    <a href="action/dwnfl.php?code=<?php echo $code; ?>&id=<?php echo $file_id; ?>&count=<?php echo $file_count; ?>"
                        ...
                        <div class="item">
                            ...
                            <p class="message">
                                <small class="text-muted pull-right"><i class="fa fa-clock-o"></i>
                                    <!-- 5:15 --><?php echo $com['created_at']; ?></small>
                                <a href="#" class="name">
                                    <?php echo $fullname;  ?>
                                </a>
                    ...
                    <div class="box-footer">
                        <form method="post" action="action/addfilecomment.php">
                            <div class="input-group">
                                ...
                                <input name="comment" required class="form-control"
